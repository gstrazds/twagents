...
class DQNLightning(pl.LightningModule):
    ...
    def __init__(self,
        ...
        print(f"DQNLightning {vars(self)} {kwargs}")
        self.env = gym.make(kwargs['env'])
        ...
        print(f"\nDQNLightning warm_start_steps:{self.warm_start_steps} obs_size:{obs_size}")
...
def main(cfg) -> None:
    ...
    # agent = Agent(cfg)
    #
    # game_source = GameSource(agent.cfg)
    # evaluate(agent, game_source, eval_no=0)
