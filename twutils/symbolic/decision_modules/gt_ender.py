...
from twutils.twlogic import COOK_WITH, CUT_WITH, adapt_tw_instr
...
class GTEnder(DecisionModule):
    ...
    def convert_cookbook_step_to_action(self, instr: str, gi: GameInstance):
        ...
        if verb in CUT_WITH or verb in COOK_WITH:
            ...
            if verb in CUT_WITH and entity.state.cuttable and entity.state.is_cut.startswith(verb) \
                ...
                return NoOp, with_objs  # already cooked
